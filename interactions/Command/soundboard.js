  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommandGroup((group) =>
      group
        ...
        .addSubcommand((subcommand) =>
          subcommand.setName("startup").setDescription("Play the startup sound")
        )
        .addSubcommand((subcommand) =>
    ...
    .addSubcommandGroup((group) =>
      group
        ...
        .addSubcommand((subcommand) =>
          subcommand.setName("running").setDescription("Play the running sound")
        )
        .addSubcommand((subcommand) =>
          subcommand
    ...
    .addSubcommandGroup((group) =>
      group
        ...
        .addSubcommand((subcommand) =>
          subcommand.setName("nyancat").setDescription("Play the nyancat sound")
        )
        .addSubcommand((subcommand) =>
          subcommand.setName("ohh").setDescription("Play the ohh sound")
        )
        .addSubcommand((subcommand) =>
          subcommand.setName("rimshot").setDescription("Play the rimshot sound")
        )
        .addSubcommand((subcommand) =>
