...
module.exports = async (client, interaction, args) => {
  ...
  let row = new discord.ActionRowBuilder().addComponents(btn, btn2, btn3, btn4);
        ...
        fields: [
          {
            ...
            value: `You only have **${convertTime(
              60000
            )}** to guess the answer!\n\n${opt}`,
          },
        ],
      ...
      collector.on("collect", async (trivia) => {
        ...
        if (trivia.customId === winningID) {
          ...
          await client.embed(
            {
              ...
              }**. You gave the correct answer in **${time}**.`,
              components: [
          ...
          await client.embed(
            {
              title: `🕹️・Trivia`,
              desc: `Better luck next time! The correct answer was **${
                question.options[question.correct]
              }**.`,
              components: [
                { type: 1, components: [fbtn1, fbtn2, fbtn3, fbtn4] },
