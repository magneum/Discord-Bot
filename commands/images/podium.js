...
module.exports = async (client, interaction, args) => {
  ...
  var user1Avatar = user1.displayAvatarURL({
    dynamic: false,
    size: 1024,
    extension: "png",
  });
  var user2Avatar = user2.displayAvatarURL({
    dynamic: false,
    size: 1024,
    extension: "png",
  });
  var user3Avatar = user3.displayAvatarURL({
    dynamic: false,
    size: 1024,
    extension: "png",
  });

  var img = await new DIG.Podium().getImage(
    user1Avatar,
    user2Avatar,
    user3Avatar,
    user1.tag,
